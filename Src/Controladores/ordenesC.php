				...
				echo '<script>
					swal({
						...
						confirmButtonText: "Cerrar"					
							...
							if(resultado.value){
								window.location = "http://localhost/RestauranteTest/Mesa/'.$n_mesa.'";
							}
						})
					</script>';
			}
...
//retorna lo que traiga la variable resultado
	...
	public function AgregarPedidoOrdenC(){
		...
		if(isset($_POST["comida"])){
			...
			$datosC = array("comida"=>$_POST["comida"], "id_orden"=>$_POST["id_o"], "cantidad"=>$_POST["cantidad"], "p_unitario"=>$_POST["precio"], "p_total"=>$_POST["precioF"], "extras"=>$_POST["extras"], "listo"=>$_POST["listo"]);
			...
			if($resultado == true){
				...
				window.location = "http://localhost/RestauranteTest/Orden/'.$n_mesa.'/'.$id_orden.'";
				</script>';
	...
	public function VerPedidosOrdenCprueba(){

		$tablaBD = "o_pedidos";

		$resultado = OrdenesM::VerPedidosOrdenMprueba($tablaBD);
	...
	public function BorrarPedidoC(){
		...
		if(isset($_GET["Pid"])){
			...
			if($resultado == true){
				...
				window.location = "http://localhost/RestauranteTest/Orden/'.$MN.'/'.$Oid.'";
				</script>';
